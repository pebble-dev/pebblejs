...
var textProps = ["title", "subtitle", "body"];

var textColorProps = ["titleColor", "subtitleColor", "bodyColor"];

var imageProps = ["icon", "subicon", "banner"];

var actionProps = ["up", "select", "back"];

var configProps = ["style", "backgroundColor"];

var accessorProps = textProps
  .concat(textColorProps)
  .concat(imageProps)
  .concat(configProps);
